...
//       <div className={`w-[500px] m-auto items-center text-center bg-blue-500 mt-4 ${register == true ? 'hidden': '' } `}>
//         <div className=' h-[60px]'>
//           <h1 className='text-[30px]'>Vendor Registration</h1>
//         </div>
//         <div className='m-auto w-[500px] h-[600px] border border-gray-700 rounded-lg'>
...
//           <div className='h-[10%]'> <button onClick={handleRegisterVendor} className="p-2 bg-green-700 rounded-lg">Register as Vendor</button></div>
...
export default function Registervendor() {
  ...
  return (
    <>
     {register ? (
      <Itemlist/>
     ): (<Vendorregister onRegister={()=>setregister(true)}/>)}
    </>
  )
}
